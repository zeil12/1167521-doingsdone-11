...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $fields = ['title' => FILTER_DEFAULT, 'project' => FILTER_DEFAULT, 'date' => FILTER_DEFAULT, 'file' => FILTER_DEFAULT];
    ...
    if (count($errors))
    {
        ...
        $page_content = include_template('form-task.php', ['errors' => $errors, 'projects' => $projects, 'task' => $task,

        ]);
        $layout_content = include_template('layout.php', ['content' => $page_content, 'users' => $users, 'title' => 'Дела в порядке | Добавление задачи']);
...
$page_content = include_template('form-task.php', ['projects' => $projects, 'id' => $id, 'errors' => $errors]);
$layout_content = include_template('layout.php', ['content' => $page_content, 'users' => $users, 'title' => 'Дела в порядке | Добавление задачи']);
print ($layout_content);
